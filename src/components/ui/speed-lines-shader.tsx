...
// uso como fundo: preenche o container pai (que deve ser relative)
...
// export original do demo (tela cheia)
export const Component = () => {
  return (
    <div className={cn("flex h-[100vh] w-full flex-col items-center gap-4 rounded-lg p-0")}>
      <Canvas orthographic camera={{ position: [0, 0, 1], zoom: 1 }} dpr={[1, 2]}>
        <color attach="background" args={["#000000"]} />
        <FullscreenShader />
      </Canvas>
