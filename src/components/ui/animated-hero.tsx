...
function Hero() {
  ...
  const titles = t("hero.rotating") as string[]
  const proof = t("hero.proof") as string[]
        ...
        >
          ...
          >
            <Button size="lg" className="gap-4" variant="outline" asChild>
              <a href="#demo">
                {t("cta.how")} <PhoneCall className="h-4 w-4" aria-hidden="true" />
              </a>
            </Button>
            <Button size="lg" className="gap-4" asChild>
              <a href={waUrl(t("contact.waText"))} target="_blank" rel="noopener noreferrer">
                {t("cta.demo")} <MoveRight className="h-4 w-4" aria-hidden="true" />
              </a>
            </Button>
          </motion.div>
